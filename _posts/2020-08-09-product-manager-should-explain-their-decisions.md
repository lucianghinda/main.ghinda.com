...
description: "When creating a customer-oriented organization or even a product organisation an important task is to help everyone understand of how to make product decisions"
---

![Quote from The Professional Product Owner Book]({{ "//assets/images/articles/2020/08/product-owner-narrative.png" | absolute_url }}){:.full-width-img.rounded.shadow}
...
It could also be that a Product Manager takes a decision based on a vision of the future, based on a "feeling" of the future, not only based on data. 
In this case, communicate what the vision of the future is and what makes it probable. 
