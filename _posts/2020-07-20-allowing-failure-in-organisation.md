...
description: "Before going into creating a significant strategy for employee engagement or for building an innovation culture, the first start is to look around and answer the question: How do we react to failure?"
---

![Peopleware Quote about failure]({{ "//assets/images/articles/2020/07/peopleware-quote-allow-failure.png" | absolute_url }}){:.full-width-img.rounded.shadow}
