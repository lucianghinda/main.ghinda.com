...
description: A summary of the origin of the brainstorming technique as Alex Osborn described it in 1953 in the famous book "Applied Imagination."
---
...
The size of the group should be between 5 and 10 participants. 
Profile of the participant: should be a self-starter and should have experience with the matter/area related to the brainstorming subject.
...
![Brainstorming activity by Osborn 1948]({{ "/assets/images/articles/osborn-brainstorming.png" | absolute_url }}){:.full-width-img}
...
There are more recent variations of these questions, worth mentioning is the SCAMPER idea generation method. Interaction Design has a great resource about [how to use SCAMPER ideation method](https://www.interaction-design.org/literature/article/learn-how-to-use-the-best-ideation-methods-scamper). 